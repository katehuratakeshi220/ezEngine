...
void ezBeamComponent::CreateMeshes()
{
  ...
  meshName.Format("ezBeamComponent_{0}_{1}_{2}_{3}.createdAtRuntime.ezMesh", m_fWidth, ezArgF(targetPositionInOwnerSpace.x, 3), ezArgF(targetPositionInOwnerSpace.y, 3), ezArgF(targetPositionInOwnerSpace.z, 3));
